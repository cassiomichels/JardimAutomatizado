...
<head>
	<title>Login Jardim Automatizado</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="controleUsuario.php">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" name="opcao" value="Entrar">
							Entrar
						</button>
					</div>
