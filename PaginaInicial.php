...
if($_SERVER["HTTPS"] != "on") {
  die("<script>alert('Sua conexão não é segura, favor utilizar HTTPS, sua segurança é nosso maior objetivo');</script>");
}


ini_set('session.cookie_httponly', true); // Impede ataques de javascript XSS destinados a roubar o ID da sessão
      ...
      <div class="container">
        <div class="row slider-text align-items-center justify-content-center">
          <div class="col-md-10 ftco-animate text-center">
            ...
            <p>As informações coletadas no sensor são apresentadas em tempo real e atualizadas a cada 30 segundos, também será disponibilizado a data e hora que o sistema ligou ou desligou
        ...
        <div class="container-fluid">
          <div class="row no-gutters justify-content-center mb-5 pb-5">
            <div class="col-md-7 text-center heading-section ftco-animate">
              ...
              <h2>Informações dos Atuadores <a href="https://twitter.com/JAutomatizado?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Siga @JAutomatizado</a>
                <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
              </h2>
              <div class="text">
                <a class="twitter-timeline" href="https://twitter.com/JAutomatizado?ref_src=twsrc%5Etfw">Informações dos Atuadores</a>
                <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
              </div>
            </div>
